...
public class OAuth2Connection<A> extends AbstractConnection<A> {
	...
	public OAuth2Connection(String providerId, String providerUserId, String accessToken, String refreshToken, Long expireTime,
			String openid, OAuth2ServiceProvider<A> serviceProvider, ApiAdapter<A> apiAdapter) {
		super(apiAdapter);
	...
	private void initApi() {
		WeChatServiceProvider provier = (WeChatServiceProvider)serviceProvider;
		api = (A) provier.getApi(accessToken, openid);
	}
